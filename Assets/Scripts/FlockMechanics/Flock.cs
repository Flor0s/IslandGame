...
public class Flock : MonoBehaviour
{
    ...
    private void GenerateUnits()
    {
        ...
        for (int i = 0; i < flockSize; i++)
        {
            ...
            allUnits[i] = Instantiate(flockUnitPrefab, spawnPosition, rotation, gameObject.GetComponentInParent<Transform>());
